    ...
    function sortItemReg(){
        layui.use('form', function () {
            ...
            form.on('select(sort_item1)', function () {
                ...
                //     $('#potential_peroid').attr('disabled', false);
                //     if($('#sort_item').val() == 'potential index by academicage'){
                //         $('#academicage').attr('disabled', false);
                //     }
                //     else{
                //         $('#academicage').attr('disabled', true);
                //     }
                //     form.render();
                // }else {
                //     $('#potential_peroid').attr('disabled', true);
                //     $('#academicage').attr('disabled', true);
                //     form.render();
                // }
                ...
                //     form.render();
                // } else if (($('#sort_item').val() == 'potential index') || ($('#sort_item').val() == 'potential index by growthrate')){
                //     $('')
                // }
                ...
                //     $('#academicage_select').addClass("layui-hide");
                //     form.render();
                // } else if (($('#sort_item').val() != 'potential index')&&($('#sort_item').val() != 'potential index by academicage')&&($('#sort_item').val() != 'potential index by growthrate')){
                //     $('#period_label').addClass("layui-hide");
                //     $('#period_select').addClass("layui-hide");
                //     $('#academicage_label').addClass("layui-hide");
                //     $('#academicage_select').addClass("layui-hide");
