!function () {
    ...
    var u = a.clear, l = a.bind, c = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.msRequestAnimationFrame || window.oRequestAnimationFrame || function (e) {
        ...
        }, d = window.cancelAnimationFrame || window.webkitCancelAnimationFrame || window.mozCancelAnimationFrame || window.msCancelAnimationFrame || window.oCancelAnimationFrame || window.clearTimeout, h = function (e) {
    ...
    new (function () {
        ...
        return v(e, [{
            ...
            key: "drawCanvas", value: function () {
                ...
                t.clearRect(0, 0, n, o);
                var a = void 0, u = void 0, l = void 0, c = void 0, d = void 0, h = void 0;
                r.forEach(function (r, m) {
                    for (r.x += r.xa, r.y += r.ya, r.xa *= r.x > n || r.x < 0 ? -1 : 1, r.ya *= r.y > o || r.y < 0 ? -1 : 1, t.fillRect(r.x - .5, r.y - .5, 1, 1), u = m + 1; u < s.length; u++)null !== (a = s[u]).x && null !== a.y && (c = r.x - a.x, d = r.y - a.y, (h = c * c + d * d) < a.max && (a === i && h >= a.max / 2 && (r.x -= .03 * c, r.y -= .03 * d), l = (a.max - h) / a.max, t.beginPath(), t.lineWidth = l / 2, t.strokeStyle = "rgba(" + e.c.color + "," + (l + .2) + ")", t.moveTo(r.x, r.y), t.lineTo(a.x, a.y), t.stroke()))
